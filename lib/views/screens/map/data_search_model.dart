...
List<DataSearchModel> dataSearchModelFromJson(String str) =>
    List<DataSearchModel>.from(
        json.decode(str).map((x) => DataSearchModel.fromJson(x)));

String dataSearchModelToJson(List<DataSearchModel> data) =>
